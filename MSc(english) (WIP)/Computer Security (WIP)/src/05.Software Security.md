...
How to solve this? What's our idea?
A NOP can be seen as an instruction which says "do nothing and go to next cell".
We can insert a sequence of NOP instructions before our code, known as a _NOP sled_. Generally since we don't know exactly the address to jump to, we jump "somewhere" in the NOP sled, the cpu will execute all NOPs and at the end it will execute our code. 

Historically, goal of the attacker is to spawn a (privileged) shell (on a local/remote machine)

A shell code is a set of machine instructions that basically can do anything. 

[Shell-Storm](http://shell-storm.org/)

An example of shellcode is:
...
![](images/8e7ed24518bd22c3f2c341b2adaa7b87.png)
