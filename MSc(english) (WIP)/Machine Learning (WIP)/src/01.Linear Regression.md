...
The least square estimate of $w$ has the smallest variance among all linear unbiased estimates. But note there are maybe other biased solutions with smalle MSE (Mean Square Error, [06. Inferenza parametrica](06.%20Inferenza%20parametrica.md)). 
