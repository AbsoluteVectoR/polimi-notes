...
The idea is to understand programming languages deeply. A brief history of programming languages:
...
Not very useful to write real stuff, more useful to learn new concepts and be flexible. We will never used this languages in our careers. 