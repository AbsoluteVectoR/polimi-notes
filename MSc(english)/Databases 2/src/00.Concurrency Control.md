...
![](Pasted%20image%2020230125113015.png)
...
The algorithm is a distributed one and it communicates the waiting sequences to other instances of the same algorithm.
